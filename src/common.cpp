...
namespace multiverso { namespace lightlda 
{
    ...
    int32_t Config::num_alpha_iterations = 100;
    int32_t Config::learn_alpha_every = 5;
    ...
    void Config::Init(int argc, char* argv[])
    {
        ...
        for (int i = 1; i < argc; ++i)
        {
            ...
            if (strcmp(argv[i], "-learn_alpha_every") == 0) learn_alpha_every = atoi(argv[i + 1]);
            ...
            if (strcmp(argv[i], "-asymmetric_prior") == 0) asymmetric_prior = true;
    ...
    void Config::PrintTrainingUsage()
    {
        ...
        printf("-num_alhpa_iterations <arg>    Number of learning alpha iteratioins. Default: 100\n");
        printf("-learn_alhpa_every <arg>    Frequency of learning alpha. Default: 5\n");
    ...
    void Config::Check()
    {
	    ...
	    (asymmetric_prior && learn_alpha_every > num_iterations)) 
        {
            PrintUsage();
        }
    }
